  ...
  return (
    <footer ref={contactSectionRef} id="contact-section" className="relative shadow-inner flex flex-col bg-light-blue pt-6 h-max">
      ...
      <div className="bg-black w-full h-fit mt-10 text-white flex items-center justify-center flex-col">
        <div className="font-thin my-5 text-sm flex w-[75vw] h-16 items-center">
          Ce site a été réalisé à la main et il est déployé avec Nginx sur un VPS sous Ubuntu. Celui-ci à été crée dans le cadre de ma certification OPENCLASSROOMS et ne présente que les projets associées à celle-ci.
        </div>
