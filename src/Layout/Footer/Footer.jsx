    ...
    <footer id="contact-section" className="relative shadow-inner flex flex-col bg-light-blue pt-6 h-max">
      ...
      <div className=" flex flex-col md:flex-row justify-between items-center h-full w-full px-10 gap-7">
          ...
          <div className="flex flex-col px-2 md:px-10 justify-center md:items-start bg-footer-blue rounded-md py-10 w-full md:w-3/4 gap-3 ">
            ...
            <p className="text-lg text-center md:flex md:gap-5 md:items-center md:text-justify">Via email : <a className="text-xl font-bold md:h-12 " href="mailto:steviggio@gmail.com" type="email">steviggio@gmail.com</a></p>
            <p className="text-lg text-center md:text-left">Ou en m'envoyant un message via les réseaux présent dans les <span className="font-bold ">"Liens utiles"</span></p>
          </div>
