        ...
        <section>
          <div className="flex ">
            ...
            <div className=" flex flex-col w-1/2 items-center justify-center">
              <h3 className='text-2xl underline mb-3'>Skills tree</h3>
              <div className='h-72 w-9/12 flex flex-col justify-center border rounded-t-full'>
              ...
              <div className='h-72 w-9/12 flex flex-col justify-center items-center border rounded-b-full'>
