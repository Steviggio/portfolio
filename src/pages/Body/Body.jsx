        ...
        <section id="body-section" className='bg-home-blue'>
          <div className="flex h-screen mx-auto w-4/5 py-16">
            <div className="flex flex-col w-2/3 justify-center gap-5 text-left">
              <h3 className="pl-3 text-8xl underline">Steviggio</h3>
              <p className="pl-3 text-3xl">Moi, c'est Steve et j'utilise React.js ainsi que Node.js pour créer des applications web.</p>
            </div>
            <div className=" flex flex-col w-1/2 items-center justify-center">
              {/* <h3 className='mt-2 text-2xl underline mb-3'>Skills tree</h3> */}
              <div className='my-2 h-72 w-10/12 flex flex-col justify-center border-4 border-black rounded-t-full'>
              ...
              <div className='my-3 h-72 w-10/12 flex flex-col justify-center items-center border-4 border-black rounded-b-full'>
