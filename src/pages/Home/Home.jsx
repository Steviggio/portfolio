				...
				<div className="flex flex-col md:flex-row justify-around lg:justify-between items-center md:pt-10 relative w-full gap-5">
					...
					<div className="flex flex-col justify-evenly text-justify shadow-xl rounded-3xl bg-white w-2/3 md:w-2/4 px-5 md:mr-10 ">
						<div className="flex flex-row justify-evenly items-center">
							<div>
								<h4 className="my-6 text-2xl flex justify-center pr-1 drop-shadow-xl underline underline-offset-2 ">
									À propos de moi
								</h4>
							</div>
						</div>
						<p className="leading-relaxed lg:px-4 text-sm md:text-base mb-5 text-left">
							Passionné de langues et de culture web, j'ai démarré l'apprentissage de Javascript en autodidacte en 2018.
